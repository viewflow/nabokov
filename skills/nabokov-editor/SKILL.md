...
```sh
uvx 'nabokov>=26.7.10' --format=flake8 <file>  # first call: pins the floor these notes assume
...
**These notes describe nabokov 26.7.10 or newer.** The skill and the linter ship
