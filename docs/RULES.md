...
|------|------|-----|-------|---------|
| `NB501` | ai-negation-contrast | warning / info | "it's not X, it's Y" / "not only X but Y" antithesis, and "No X, no Y, just Z". Also (info) the "no longer" reframe: the same third-person subject renamed across two sentences with a copula swap. First person ("I'm no longer at the bank. I'm…") is autobiography and exempt. | "This **isn't just fast, it's** transformative."; "**They're no longer** entertainment. **They're** market research." |
