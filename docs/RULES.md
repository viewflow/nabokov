...
| `NB519` | ai-artifact | warning | Fingerprints: chat citation tokens, AI-tool URL parameters, unfilled placeholders, knowledge-cutoff disclaimers. No density gating. | "**citeturn0search0**", "**[Your Name]**" |
