...
_AI_ARTIFACTS = [
    ...
    # Invisible characters and mixed-script homoglyphs used to live here. They
    # moved to NB317 (checks/characters.py) and are on by DEFAULT now: the
    # detection research shows a detector normalizes them away before scoring,
    # so their presence says nothing about authorship — it is a plain defect
    # that breaks search and copy-paste for every reader. Do not add them back;
    # a duplicate would report the same span twice.
]
